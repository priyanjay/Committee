...
@WebServlet("/ShowRemainingMembers")
public class ShowRemainingMembers extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.print("<form action='SelectCommittee' method='post'><table border='2' style='width:800px;'>");
			...
			out.print("<tr><td></td><td></td><td><input type ='submit' name='submit' value='Find Members'/></td></tr></table></form");
